...
if (mainmenuTextText.value == "job" || menuText.value == "jobs" || menuText.value == "الوظائف" || menuText.value == "وظيفه") {
    menuText.value == ""
open("job.html" ,"")
}
...
resultText = document.querySelector(".result-search-bar .resultText");
resultSubmit = document.querySelector(".result-search-bar .resultSubmit");
console.log(resultText)
resultSubmit.onclick = function (e) {
if (resultText.value == "services" || resultText.value == "service" || resultText.value == "الخدمات" ||   resultText.value == "خدمات") {
    resultText.value = ""
open("services.html" ,"")
}
if (resultText.value == "مقالاتنا" || resultText.value == "article" || resultText.value == "المقالات" ||   resultText.value == "مقالاتنا") {
    resultText.value = ""
open("articles.html" ,"")
}
if (resultText.value == "الرئيسيه" || resultText.value == "main" ) {
    resultText.value = ""
open("index.html" ,"")
}
if (resultText.value == "تواصل معنا" || resultText.value == "contact" || resultText.value == "التواصل" || resultText.value == "اتصل بنا" || resultText.value == "التواصل") {
    resultText.value == ""
open("contact.html" ,"")
}
if (resultText.value == "job" || resultText.value == "jobs" || resultText.value == "الوظائف" || resultText.value == "وظيفه") {
    resultText.value == ""
open("job.html" ,"")
}
if (resultText.value == "الكشف الاونلاين" || resultText.value == "كشف" || resultText.value == "الكشف" || resultText.value == "medical") {
resultText.value == ""
open("medical.html" ,"")
}
else {
